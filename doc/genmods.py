...
PLOTS_OPTIONS = {
    "absolute": False,  # True if package.module in table of contents
    "dest": "plots",  # Destination directory for the api docs
    "root": None,  # Source directory for the package, or None for default
}
PLOTS_PACKAGE = "bumps.plots"
PLOTS_MODULES = [
...
def make():
    ...
    # TODO: include docs for plots and webserver; be sure to update index.rst
    # gen_api_docs(PLOTS_PACKAGE, PLOTS_MODULES, **PLOTS_OPTIONS)

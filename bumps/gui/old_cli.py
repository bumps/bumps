...
Refl1D application uses the following::
    ...
    from bumps.gui.old_cli import main as bumps_main
...
:func:`load_pbest` to load the best value  found in the fit.  This can
...
from ..fitproblem import load_pars as load_best, load_problem
...
def main():
    ...
    """
    from . import old_options as options
    ...
    if opts.edit:
        ...
        from .gui_app import main as gui

"""Client stubs autogenerated from bumps.webview.client ***DO NOT EDIT***"""
import typing
...
def remote_bumps(url: str | None = None, **kwargs: Any) -> typing.AsyncGenerator[bumps.webview.client.BumpsClient, NoneType]:

...
def _format_uncertainty(value, uncertainty, compact):
    ...
    val_place = int(math.floor(val_place / 3.0)) * 3
    ...
    val_str = "%.*f" % (digits_after_decimal, value / 10.0**val_place)
    exp_str = "e%d" % val_place if val_place != 0 else ""
    if compact is None:
        result = "".join((sign, val_str, exp_str))
    elif compact:
        err_str = "(%2d)" % int(uncertainty / 10.0 ** (err_place - 1) + 0.5)
        result = "".join((sign, val_str, err_str, exp_str))
    else:
        err_str = "%.*f" % (digits_after_decimal, uncertainty / 10.0**val_place)
...
def test_compact():
    ...
    assert value_str(123567.0, 76600) == "124(77)e3"
    ...
    assert value_str(1.23567, 0.766) == "1.24(77)"
    assert value_str(0.123567, 0.0766) == "0.124(77)"
    assert value_str(0.0123567, 0.00766) == "0.0124(77)"
    assert value_str(0.00123567, 0.000766) == "0.00124(77)"
    assert value_str(0.000123567, 0.0000766) == "124(77)e-6"
    assert value_str(0.0000123567, 0.00000766) == "12.4(77)e-6"
    assert value_str(0.00000123567, 0.000000766) == "1.24(77)e-6"
    assert value_str(0.000000123567, 0.0000000766) == "124(77)e-9"
    assert value_str(0.00000123567, 0.0000000766) == "1.236(77)e-6"
    assert value_str(0.0000123567, 0.0000000766) == "12.357(77)e-6"
    assert value_str(0.000123567, 0.0000000766) == "123.567(77)e-6"
    assert value_str(0.00123567, 0.000000766) == "0.00123567(77)"
    assert value_str(0.0123567, 0.00000766) == "0.0123567(77)"
    assert value_str(0.123567, 0.0000766) == "0.123567(77)"
    assert value_str(1.23567, 0.000766) == "1.23567(77)"
    assert value_str(12.3567, 0.00766) == "12.3567(77)"
    assert value_str(123.567, 0.0764) == "123.567(76)"
    assert value_str(1235.67, 0.764) == "1235.67(76)"
    ...
    assert value_str(0.123567, 0.764) == "0.12(76)"
    assert value_str(0.0123567, 0.0764) == "12(76)e-3"
    assert value_str(0.00123567, 0.00764) == "1.2(76)e-3"
    assert value_str(0.000123567, 0.000764) == "0.12(76)e-3"
    ...
    assert value_str(0.123567, 7.64) == "0.1(76)"
    assert value_str(0.0123567, 0.764) == "0.01(76)"
    assert value_str(0.00123567, 0.0764) == "0.001(76)"
    assert value_str(0.000123567, 0.00764) == "0.1(76)e-3"
...
def test_pm():
    ...
    assert value_str(123567.0, 76600) == "124e3 +/- 77e3"
    ...
    assert value_str(1.23567, 0.766) == "1.24 +/- 0.77"
    assert value_str(0.123567, 0.0766) == "0.124 +/- 0.077"
    assert value_str(0.0123567, 0.00766) == "0.0124 +/- 0.0077"
    assert value_str(0.00123567, 0.000766) == "0.00124 +/- 0.00077"
    assert value_str(0.000123567, 0.0000766) == "124e-6 +/- 77e-6"
    assert value_str(0.0000123567, 0.00000766) == "12.4e-6 +/- 7.7e-6"
    assert value_str(0.00000123567, 0.000000766) == "1.24e-6 +/- 0.77e-6"
    assert value_str(0.000000123567, 0.0000000766) == "124e-9 +/- 77e-9"
    assert value_str(0.00000123567, 0.0000000766) == "1.236e-6 +/- 0.077e-6"
    assert value_str(0.0000123567, 0.0000000766) == "12.357e-6 +/- 0.077e-6"
    assert value_str(0.000123567, 0.0000000766) == "123.567e-6 +/- 0.077e-6"
    assert value_str(0.00123567, 0.000000766) == "0.00123567 +/- 0.00000077"
    assert value_str(0.0123567, 0.00000766) == "0.0123567 +/- 0.0000077"
    assert value_str(0.123567, 0.0000766) == "0.123567 +/- 0.000077"
    assert value_str(1.23567, 0.000766) == "1.23567 +/- 0.00077"
    assert value_str(12.3567, 0.00766) == "12.3567 +/- 0.0077"
    assert value_str(123.567, 0.0764) == "123.567 +/- 0.076"
    assert value_str(1235.67, 0.764) == "1235.67 +/- 0.76"
    ...
    assert value_str(0.123567, 0.764) == "0.12 +/- 0.76"
    assert value_str(0.0123567, 0.0764) == "12e-3 +/- 76e-3"
    assert value_str(0.00123567, 0.00764) == "1.2e-3 +/- 7.6e-3"
    assert value_str(0.000123567, 0.000764) == "0.12e-3 +/- 0.76e-3"
    ...
    assert value_str(0.123567, 7.64) == "0.1 +/- 7.6"
    assert value_str(0.0123567, 0.764) == "0.01 +/- 0.76"
    assert value_str(0.00123567, 0.0764) == "0.001 +/- 0.076"
    assert value_str(0.000123567, 0.00764) == "0.1e-3 +/- 7.6e-3"
